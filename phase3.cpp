...
//this project is to use separate compilation to model the medieval games
//between nobles that has armies. We split the files into 5, two header files,
//two implementation files and one testing file
